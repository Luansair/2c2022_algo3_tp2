...
public class BotonReliantEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonReliantEventHandler(Juego juego, Button botonMoto, Button botonCuatroPorCuatro, Button botonDesabilitado)  {
        this.juego = juego;
